...
function ItemEdit({ itemElem }) {
    ...
    for (const [type, value] of Object.entries(skillAwakes)) {
        ...
        for (const [skill, rarities] of Object.entries(value.skills)) {
            ...
            possibleSkillAwakeOptions[skill] = Utils.getSkillById(skill).name[skillLangKey] ?? Utils.getSkillById(skill).name.en;
        }
    ...
    const possibleElementValues = {
        "none": i18n.t("element_none"),
        "fire": i18n.t("element_fire"),
        "water": i18n.t("element_water"),
        "electricity": i18n.t("element_electricity"),
    ...
    return (
        <div className="item-edit">
...

            {
                ...
                <div className="column">
                    <h3>{i18n.t("itemedit_piercing_slots", { current: itemElem.piercings.length, max: itemElem.getMaximumPiercingSlots() })}</h3>
...

            {
                ...
                <div className="column">
                    <h3>{i18n.t("itemedit_jewels", { current: itemElem.ultimateJewels.length, max: itemElem.getMaximumUltimateJewelSlots() })}</h3>
                    <div id="edit-piercing">
                        {
